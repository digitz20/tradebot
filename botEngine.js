    ...
    for(const symbol of pairs){
      ...
      try{
        ...
        try {
          ...
          continue; // Skip this iteration if balance fetch fails
        }
        ...
        if(lastATR > 2*ATRcalculate(closes1)){ log("ATR spike detected. Skipping."); continue; }
...
if (require.main === module) {
  const pairs = ["BTCUSDT", "ETHUSDT"]; // Example pairs, adjust as needed
